...
var lagu = [
  ['Mangu', 'Fourtwnty', 4000, 8000, 'Mangu.jpg', 'Mangu.mp3', 'mangu.mp4', 'Lagu Baru'],
  ['Slalu Ada di Nadi', 'B.C.L', 1500, 2300, 'Selalu ada di nadimu.jpg', 'Selalu ada di.mp3', 'slale ada di nadi.mp4', 'Original Soundtrack From "JUMBO"'],
  ['Lesung Pipi', 'Raim LaOde', 2440, 5400, 'Lesung Pipi.jpg', 'Lesung pipi.mp3', 'lesung pipi.mp4', 'Sebuah Kisah'],
];
...
lagu.forEach(function (item, index) {
  var [title, artist, likes, views, coverImg, audioSrc, videoSrc, description] = item;
